...
<div class="xxl:container flex justify-center items-center font-sans">
        <div class="border-t-2 flex flex-col sm:w-6/12 md:w-2/5 lg:w-2/6 xl:w-1/4 2xl:w-1/5 w-11/12 px-10 py-7 mt-28 shadow-sm shadow-sky-950 rounded-md">
            <h1 class="text-center md:text-4xl text-3xl mb-6">eCARES</h1>
