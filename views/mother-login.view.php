...
<div class="xxl:container flex justify-center items-center font-sans">
        <div class="border-t-2 flex flex-col sm:w-6/12 md:w-2/5 lg:w-2/6 xl:w-1/4 2xl:w-1/5 w-11/12 px-10 py-8 mt-28 shadow-sm shadow-sky-950 rounded-md">
            ...
            <h2 class="text-center text-2xl font-medium mb-6">Postpartum Mother</h2>
            <form action="">
                <input type="text" class="py-2 px-4 block w-full border-gray-200 rounded-md border outline-none text-lg mb-5" placeholder="Phone">
                ...
                <input type="submit" class="bg-rose-500 hover:bg-rose-700 p-3 mb-6 text-center rounded-xl text-white w-full cursor-pointer" value="Sign In">

                <p class="text-center text-sm">Dont have an account? <a href="#" class="text-rose-500">Sign up here</a></p>    
            </form>
        </div>
    </div>
