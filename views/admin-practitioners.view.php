...
<head>
    ...
    <title>Admin Health Practitioners</title>
...
<body class="overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-sky-900 dark:[&::-webkit-scrollbar-thumb]:bg-sky-950 font-sans">
    ...
    <div class="flex">
        ...
        <div id="main-content" class="bg-slate-100 dark:bg-sky-900 w-full">
            ...
            <div id="pending-accounts-modal" class="hs-overlay hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto pointer-events-none" role="dialog" tabindex="-1" aria-labelledby="pending-accounts-label">
                <div class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-14 opacity-0 ease-out transition-all md:max-w-2xl md:w-full m-3 md:mx-auto">
                    <div class="flex flex-col bg-gray-200 dark:bg-sky-900 border shadow-sm rounded-xl pointer-events-auto">
                        <div class="flex justify-between items-center py-3 px-6">
                            <h3 id="pending-accounts-label" class="font-bold text-gray-800 text-lg dark:text-gray-300">
                            Pending Accounts
                            </h3>
                            <button type="button" class="hs-dropup-toggle size-8 inline-flex justify-center items-center gap-x-2 rounded-full border border-transparent bg-gray-100 text-gray-800 hover:bg-gray-200 focus:outline-none focus:bg-gray-200 disabled:opacity-50 disabled:pointer-events-none" aria-label="Close" data-hs-overlay="#pending-accounts-modal">
                            <span class="sr-only">Close</span>
                            <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M18 6 6 18"></path>
                                <path d="m6 6 12 12"></path>
                        ...
                        <div class="message-response justify-end mb-2 w-full flex pe-5">
                            <div class="max-w-xs bg-white border border-gray-200 rounded-xl shadow-lg dark:bg-neutral-800 dark:border-neutral-700 hidden" role="alert" tabindex="-1" aria-labelledby="hs-toast-success-example-label">
                            ...
                            <div class="max-w-xs bg-white border border-gray-200 rounded-xl shadow-lg dark:bg-neutral-800 dark:border-neutral-700 hidden" role="alert" tabindex="-1" aria-labelledby="hs-toast-error-example-label">
                                <div class="flex p-2">
                                    <div class="shrink-0">
                        ...
                        <div class="pb-5 flex flex-col items-start px-6">
                            <div class="w-full grid grid-cols-3 mb-2">
                                <h3 class="mb-2 dark:text-white text-gray-700 text-base font-semibold">Username</h3>
                                <h3 class="mb-2 dark:text-white text-gray-700 text-base font-semibold">Role</h3>
                                <h3 class="mb-2 dark:text-white text-gray-700 text-base font-semibold">Action</h3>
                            </div>
                            
                            <div class="grid grid-cols-3 items-center w-full">
                                <h3 class="text-base dark:text-white">jologalabay</h3>
                                <h3 class="text-base dark:text-white">Health Practitioner</h3>
                                <div class="action">
                                    <input type="button" class="py-1 px-2 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-none disabled:opacity-50 disabled:pointer-events-none cursor-pointer" value="Approve">                           
                                    <input type="button" class="py-1 px-2 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-rose-600 text-white hover:bg-rose-700 focus:outline-none disabled:opacity-50 disabled:pointer-events-none cursor-pointer" value="Decline">
                                </div>                                                    
                            </div>
                        </div>
